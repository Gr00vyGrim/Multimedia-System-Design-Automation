'''
1.) Download my amazing VP video, https://mycsun.box.com/s/v55rwqlu5ufuc8l510r8nni0dzq5qki7Links to an external site.​

(*COMPLETED*)

2.) Run script with new argparse command --process <video file> ​

(*ADDED ARGMENT / NO FUNCTION*)
...
6.) Create Thumbnail (96x74) from each entry in (3), but middle most frame or closest to. Add to XLS file to it's corresponding range in new column ​

7.) Render out each shot from (3) and upload them using API to frame.io(https://developer.frame.io/api/reference/)
---------------------------------------------------------------

Deliverables​

Copy/Paste code​
Excel file with new columns noted on Solve (5) and (6)​
Screenshot of Frame.io account (7)
...
'''
python3 comp467_proj3.py --process twitch_nft_demo.mp4 --output XLS
'''
